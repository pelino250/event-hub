...
class EventAPITests(TestCase):
    def setUp(self):
        ...
        self.invalid_detail_url = reverse('event-detail', args=[999])  # Non-existent event
    ...
    def test_create_event_with_image(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(settings.MEDIA_ROOT, event.image.name)))
